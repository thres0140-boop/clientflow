...
import { splitExamples, joinExamples } from "@/features/scripts/server/exampleScripts";

// Re-export so existing server imports from this module keep working.
export { splitExamples, joinExamples, EXAMPLE_SEP } from "@/features/scripts/server/exampleScripts";
