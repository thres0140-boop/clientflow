...
import { ensureReelVideo } from "@/ai/features/instagram/server/reelCapture";
...
export async function POST(req: NextRequest) {
  ...
  const playable = resolved.startsWith(`${AI_API}/`) ? resolved : `/api/vid?u=${encodeURIComponent(resolved)}`;
