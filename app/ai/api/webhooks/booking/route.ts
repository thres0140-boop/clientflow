...
import { todayYMD } from "@/ai/features/analytics/server/analyticsBump";

/**
 * Booking webhook — called by Calendly or Cal.com when someone books.
 *
 * Usage:
 *   Webhook URL: https://ordoagency.com/ai/api/webhooks/booking?clientId=<ID>   (AI product — see ai/slug.ts)
