...
import { verifySessionToken, createSessionToken } from "@/ai/shared/auth/session";
...
export async function GET(req: NextRequest) {
  ...
  const res = NextResponse.json({
    ...session,
    ownerName: process.env.AI_OWNER_NAME ?? "Owner",
    ownerEmail: process.env.AI_OWNER_EMAIL ?? null,
    projects,
  });
