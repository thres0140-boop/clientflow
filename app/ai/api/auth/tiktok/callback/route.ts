...
import { exchangeCode, saveTokens } from "@/ai/features/tiktok/server/tiktokOAuth";
...
export async function GET(req: NextRequest) {
  ...
  const cookieState = req.cookies.get("tt_ai_oauth_state")?.value;
  ...
  res.cookies.delete("tt_ai_oauth_state");
  return res;
}
