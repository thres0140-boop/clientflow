...
export default function App() {
  ...
  function renderPage() {
    ...
    switch (page) {
      ...
      case "kanban": return <Kanban clients={clients} selectedClientId={selectedClientId} onSelectClient={setSelectedClientId} activeProfileId={activeProfileId} team={team} ownerName={ownerName} />;
