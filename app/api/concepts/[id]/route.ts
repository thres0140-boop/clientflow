...
export async function PUT(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  const concept = await prisma.concept.update({
    ...
    data: {
      ...
      ...(body.clientIntervalDays !== undefined ? { clientIntervalDays: body.clientIntervalDays === "" || body.clientIntervalDays == null ? null : parseInt(body.clientIntervalDays) } : {}),
      ...(body.clientAnchor !== undefined ? { clientAnchor: body.clientAnchor || null } : {}),
